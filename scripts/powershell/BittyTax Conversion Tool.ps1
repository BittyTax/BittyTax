<#
    ...
    This script lets you select data file(s) to be processed by the BittyTax Conversion Tool
...
function Show-FileDialog {
    ...
    $openFileDialog.Title = 'Select data file(s) for BittyTax to convert:'
...
function Show-ArgumentInputBox {
    ...
    $form.Text = 'BittyTax Conversion Tool'
    ...
    $label.Text = "Add extra 'bittytax_conv' command arguments?"
...
function Show-SuccessMessageBox {
    ...
    $label.Text = 'Conversion successful. Open Spreadsheet or Show in Folder?'
    $label.AutoSize = $true

...
def parse_bitfinex_trades(
    ...
    if (Decimal(row_dict["AMOUNT"]) > 0):
        ...
        sell_quantity = (Decimal(row_dict["PRICE"]) * Decimal(row_dict["AMOUNT"])).quantize(PRECISION)
        ...
        buy_quantity = (Decimal(row_dict["PRICE"]) * abs(Decimal(row_dict["AMOUNT"])).quantize(PRECISION))

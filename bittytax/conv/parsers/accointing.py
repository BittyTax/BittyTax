...
DataParser(DataParser.TYPE_ACCOUNTING,
           ...
           ['timeExecuted', 'type', 'boughtQuantity', 'boughtCurrency', 'boughtCurrencyId',
            ...
            'feeCurrencyId', 'classification', 'walletName', 'walletProvider', 'providerId', 'txId',
            ...
            'temporaryFeeCurrencyTicker', 'id', 'associatedTransferId', 'comments', 'fiatValueOverwrite', 'feeFiatValueOverwrite'],
